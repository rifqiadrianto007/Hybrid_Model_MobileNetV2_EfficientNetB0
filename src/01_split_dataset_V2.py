...
def collect_images(root_dir: Path, source_name: str = "dataset") -> pd.DataFrame:
    rows = []
...
def main() -> None:
    ...
    parser.add_argument("--raw-dir", type=str, default=None) # Folder dataset mentah tunggal
    ...
    raw_dir = Path(args.raw_dir).resolve() if args.raw_dir else base_dir / "data" / "raw" # Folder dataset mentah tunggal
    ...
    # DataFrame dari folder dataset tunggal
    data_df = collect_images(raw_dir, "dataset")
